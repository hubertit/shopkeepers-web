...
if (isset($_GET["id"])) {
    ...
    <head>
        ...
        <title> <?php print $category["category_name"]?></title>
        ...
        <main>
            ...
            <div class="epix-breadcrumb-area mb-40">
                ...
                <div class="epix-breadcrumb">
                    <ul>
                        <li><a href="./">Home</a></li>
                        <li><span><?php print $category["category_name"]?></span></li>
                    </ul>
                </div>
                </div>
            </div>
                                ...
                                <div class="epix-shop-product-topbar">
                                    <div class="epix-content-header mb-55">
                                        ...
                                        <div class="epix-ch-right">
                                            <div class="show-text">
                                                <?php
                                                $query = mysqli_query($connection, "SELECT * FROM shops, sales, shop_categories WHERE country_id ='1' AND shop_categories.category_id ='$categoryId' AND shop_categories.shop_id = shops.shop_id AND sales.shop_id = shops.shop_id ");
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="grid-view">
                                                <div class="row">
                                                    ...
                                                    if (isset($_GET["page"])) {
                                                        ...
                                                        $query = mysqli_query($connection, "SELECT * FROM shops, sales, shop_categories WHERE country_id ='1' AND shop_categories.category_id ='$categoryId' AND shop_categories.shop_id = shops.shop_id  AND sales.shop_id = shops.shop_id  ORDER BY shops.shop_id DESC LIMIT $show, 24 ") or die(mysqli_error($connection));
                                                    } else {
                                                        $query = mysqli_query($connection, "SELECT * FROM shops, sales, shop_categories WHERE country_id ='1' AND shop_categories.category_id ='$categoryId' AND shop_categories.shop_id = shops.shop_id  AND sales.shop_id = shops.shop_id  ORDER BY shops.shop_id DESC LIMIT 24 ") or die(mysqli_error($connection));
                                                    }
                                            ...
                                            <div class="tab-pane fade" id="list-view" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                ...
                                                if (isset($_GET["page"])) {
                                                    ...
                                                    $query = mysqli_query($connection, "SELECT * FROM shops WHERE country_id ='1'  ORDER BY shop_id DESC LIMIT $show, 24 ") or die(mysqli_error($connection));
                                                } else {
                                                    $query = mysqli_query($connection, "SELECT * FROM shops WHERE country_id ='1'  ORDER BY shop_id DESC LIMIT 24 ") or die(mysqli_error($connection));
                                                }
                                                while ($data = mysqli_fetch_assoc($query)) {
                                                    $data["shop_password"] = null;
