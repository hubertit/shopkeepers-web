                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  categories ORDER BY category_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    $shopsQuery = mysqli_query($connection, "SELECT * FROM shop_categories, shops WHERE category_id ='$categoryId' AND shops.shop_id = shop_categories.shop_id ");
                                                    $count = mysqli_num_rows($shopsQuery);
                                                    print $count;
                                                    ?></td>
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="editCategory?id=<?php print($data["category_id"]); ?>">Edit</a>
                                                            <a class="dropdown-item text-danger" href="?deleteCategory=<?php print($data["category_id"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
