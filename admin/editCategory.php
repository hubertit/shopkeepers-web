                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    <input type="hidden" name="categoryId" value="<?php print $data["category_id"]; ?>">
                                                    <input type="text" class="form-control" placeholder="Category Name" name="categoryName" value="<?php print $data["category_name"]; ?>" required>
                                                </div>
                                            </div>

                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea name="categoryDescription" placeholder="Category Description" class="form-control" id="" cols="30" rows="5"><?php print $data["category_description"]; ?></textarea>
                                                </div>
                                            </div>
