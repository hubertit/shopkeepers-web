            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                ...
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            ...
                                            <tr>
                                                <td><?php print($no) ?></td>
                                                <td><?php print($data["product_name"]); ?></td>
                                                <td>RWF <?php print(number_format($data["product_price"])); ?></td>
                                                <td> <?php print($data["product_discount_price"]*100/$data["product_price"]); ?>% </td>
                                                <td> <?php print($data["product_status"]); ?></td>
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#=<?php print($data["category_id"]); ?>">Edit</a>
                                                            <a class="dropdown-item text-danger" href="?deleteProduct=<?php print($data["product_id"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                        ...
                        <a href="addProduct" class="btn btn-primary btn-rounded btn-floated"><i data-feather="plus-circle"></i></a>
                    </div>
