...
<head>
    ...
    <title> Welcome to Shopkeepers</title>
                    ...
                    <div class="col-xxl-9 col-lg-9 epix-shop-order">
                        <div class="epix-shop-products-display">
                            <div class="epix-shop-product-topbar">
                                ...
                                <div class="epix-shop-product-main" style="background-color: shop?details=<?php print $data["shop_id"] ;?>f5f5f5; padding:20px">
                                        ...
                                        <div class="tab-pane fade show active" id="grid-view">
                                            <div class="row">
                                                ...
                                                if (isset($_GET["page"])) {
                                                    ...
                                                    $query = mysqli_query($connection, "SELECT * FROM shops, sales WHERE country_id ='1' AND sales.shop_id = shops.shop_id   ORDER BY shops.shop_id DESC LIMIT $show, 24 ") or die(mysqli_error($connection));
                                                } else {
                                                    $query = mysqli_query($connection, "SELECT * FROM shops, sales  WHERE country_id ='1' AND sales.shop_id = shops.shop_id  ORDER BY shops.shop_id DESC LIMIT 24 ") or die(mysqli_error($connection));
                                                }
